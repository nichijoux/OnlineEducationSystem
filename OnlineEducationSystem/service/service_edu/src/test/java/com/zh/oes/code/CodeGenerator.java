...
public class CodeGenerator {
    // 数据库连接配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/oes?serverTimezone=GMT%2B8";
    ...
    //设置父包名
    private static final String PACKAGE_NAME = "com.zh.oes";
    //设置父包模块名
    private static final String MODULE_NAME = "edu";
    //设置MVC下各个模块的包名
